...
<article id="main">
    <section id="hero-content" class="graph">
        <h1>Microsoft 企业移动性文档</h1>
        <h2>Microsoft & #39; s 企业移动性服务使各类组织需要其员工工作效率应用程序和设备之间同时确保公司数据受到保护</h2>
        <!-- <ol id="actions" class="action-list">
        <li><a href="" class="button button-bordered">Learn More</a></li>
        </ol> -->
        <h3>企业移动性的新增内容？ <a href="https://www.microsoft.com/en-us/server-cloud/enterprise-mobility/overview.aspx" target="_blank">请访问企业移动性页上 &rarr;</a></h3>
    </section>
